...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Delineador de Ojos Azul', 'Delineador mineral de tono azul para un toque vibrante.', 15.50, 'Aceite de ricino, cera de abejas, pigmentos naturales', 'delineador_azul', 4);");
        ...
        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Jabón de Lavanda', 'Jabón natural con propiedades relajantes.', 5.00, 'Aceite esencial de lavanda, aceite de oliva, manteca de karité', 'jabon1', 5);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Jabón de Miel', 'Jabón suave con propiedades hidratantes.', 4.50, 'Miel orgánica, aceite de coco, aceite esencial de manzanilla', 'jabon2', 5);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Jabón de Rosa Mosqueta', 'Jabón natural regenerador para la piel.', 6.00, 'Aceite de rosa mosqueta, aceite de oliva, cera de abejas', 'jabon3', 5);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Jabón de Té Verde', 'Jabón antioxidante con extracto de té verde.', 5.50, 'Extracto de té verde, aceite de oliva, manteca de karité', 'jabon4', 5);");

        // Desodorantes (subcategoria_id = 6)
        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Desodorante Natural de Lavanda', 'Desodorante natural sin aluminio.', 7.00, 'Aceite de coco, bicarbonato de sodio, aceite esencial de lavanda', 'desodorante1', 6);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Desodorante de Árbol de Té', 'Desodorante antibacteriano y natural.', 6.50, 'Aceite de coco, bicarbonato de sodio, aceite esencial de árbol de té', 'desodorante2', 6);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Desodorante de Cítricos', 'Desodorante refrescante con extracto de cítricos.', 6.00, 'Aceite de coco, bicarbonato de sodio, extracto de limón', 'desodorante3', 6);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Desodorante de Romero', 'Desodorante natural con propiedades desinfectantes.', 7.50, 'Aceite de coco, bicarbonato de sodio, aceite esencial de romero', 'desodorante4', 6);");

        // Exfoliantes (subcategoria_id = 7)
        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Exfoliante de Café', 'Exfoliante natural con café para rejuvenecer la piel.', 9.00, 'Café molido, aceite de oliva, azúcar moreno', 'exfoliante1', 7);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Exfoliante de Azúcar', 'Exfoliante suave con azúcar para todo tipo de piel.', 8.50, 'Azúcar, aceite de almendras, extracto de pepita de uva', 'exfoliante2', 7);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Exfoliante de Sal Marina', 'Exfoliante corporal con sal marina y aceites esenciales.', 10.00, 'Sal marina, aceite de coco, aceite esencial de menta', 'exfoliante3', 7);");
        ...
        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Perfume Floral de Lavanda', 'Un perfume fresco con notas de lavanda y aceites esenciales.', 20.00, 'Aceite esencial de lavanda, aceite de jojoba, agua destilada', 'perfume_lavanda', 9);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Perfume Amaderado', 'Perfume con un toque cálido y terroso.', 22.00, 'Aceite esencial de sándalo, aceite de cedro, aceite de oliva', 'perfume_amaderado', 9);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Perfume Cítrico Refrescante', 'Una mezcla revitalizante de cítricos y aceites naturales.', 18.00, 'Aceite esencial de naranja, aceite de limón, aceite de coco', 'perfume_citrico', 9);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Perfume Floral de Rosa', 'Un perfume delicado con extracto de rosa y aceites florales.', 21.00, 'Aceite esencial de rosa, aceite de almendra, agua de rosas', 'perfume_rosa', 9);");

        // Brumas Corporales (Subcategoría ID: 10)
        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Bruma Corporal de Lavanda', 'Bruma refrescante con notas de lavanda y aceites orgánicos.', 15.00, 'Aceite esencial de lavanda, agua de rosa mosqueta, agua destilada', 'bruma_lavanda', 10);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Bruma Corporal Cítrica', 'Bruma ligera y energizante con aceites cítricos.', 14.50, 'Aceite esencial de limón, aceite esencial de naranja, agua destilada', 'bruma_citrica', 10);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Bruma Corporal de Rosa Mosqueta', 'Hidrata y refresca con extracto de rosa mosqueta.', 16.00, 'Agua de rosa mosqueta, aceite de jojoba, aceites esenciales', 'bruma_rosa_mosqueta', 10);");
        ...
        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Colonia Floral de Jazmín', 'Colonia suave con extracto de jazmín para un aroma fresco.', 18.00, 'Extracto de jazmín, aceite de almendra, agua destilada', 'colonia_jazmin', 12);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Colonia de Lavanda Relajante', 'Colonia fresca con notas florales de lavanda.', 17.00, 'Aceite esencial de lavanda, agua de rosas, aceite de oliva', 'colonia_lavanda', 12);");

        db.execSQL("INSERT INTO t_productos (nombre, descripcion, precio, ingredientes, imagen, subcategoria_id) VALUES (" + "'Colonia Refrescante de Limón', 'Una colonia refrescante y energética con extracto de limón.', 15.00, 'Aceite esencial de limón, agua destilada, aceite de coco', 'colonia_limon', 12);");
